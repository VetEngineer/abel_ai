                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                  <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                      ...
                      <Badge variant={stats?.userGrowthPercentage >= 0 ? "secondary" : "destructive"}>
                        {stats?.userGrowthPercentage >= 0 ? '+' : ''}{stats?.userGrowthPercentage || 0}%
                      </Badge>
                    </CardHeader>
                    <CardContent>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      ...
                      <p className="text-xs text-muted-foreground">
                        {stats?.activeAPIKeys.services.length > 0
                  ...
                  <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                      ...
                      <Badge variant={stats?.tokenUsagePercentage >= 0 ? "secondary" : "destructive"}>
                        {stats?.tokenUsagePercentage >= 0 ? '+' : ''}{stats?.tokenUsagePercentage || 0}%
                      </Badge>
                    </CardHeader>
                    <CardContent>
                  ...
                  <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                      ...
                      <Badge variant={stats?.revenuePercentage >= 0 ? "secondary" : "destructive"}>
                        {stats?.revenuePercentage >= 0 ? '+' : ''}{stats?.revenuePercentage || 0}%
                      </Badge>
                    </CardHeader>
                    <CardContent>
